...
export const zh = {
  ...
  'row.bing.get': '获取今日壁纸',
  'row.bing.next': '换一张',
  'row.bing.loading': '获取中…',
  'row.bing.error': '获取必应壁纸失败，已保留当前背景',
  'row.bing.info': '{title} · {date}',
  'row.bing.market': '地区',
  'row.bing.uhd': '4K 高清',
  'row.bing.auto': '每日自动更新',
  'preset.none': '无',
  'preset.aurora': '极光',
  'preset.sunset': '落日',
  'preset.emerald': '翡翠',
...
export const en = {
  ...
  'row.effect.off': 'Off',
  'row.bing': 'Bing wallpaper',
  'row.bing.get': "Get today's wallpaper",
  'row.bing.next': 'Another one',
  'row.bing.loading': 'Fetching…',
  'row.bing.error': 'Failed to fetch Bing wallpaper; current background kept',
  'row.bing.info': '{title} · {date}',
  'row.bing.market': 'Region',
  'row.bing.uhd': '4K UHD',
  'row.bing.auto': 'Daily auto-update',
  'preset.none': 'None',
